<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- Mart JS -->
   <script src="/easycook/resources/mart/js/vendor/jquery-1.11.2.min.js"></script>
   <script src="/easycook/resources/mart/js/vendor/bootstrap.min.js"></script>
   <script src="/easycook/resources/mart/js/isotope.pkgd.min.js"></script>
